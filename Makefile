...
images: image-gradle-toolset ## Build images.
.PHONY: images

image-gradle-toolset: ## Build gradle-toolset image.
	docker build \
        -f build/images/Dockerfile.gradle-toolset \
		-t localhost:5000/ods-pipeline/gradle-toolset \
		.
.PHONY: image-gradle-toolset
